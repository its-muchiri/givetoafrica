...
// Introduction (expanded)
  ...
  parts.push(`<p>${pickTransition()}, GiveToAfrica has been serving communities in ${location} and across Africa for many years. Our team of dedicated professionals works tirelessly to ensure that every donation is used effectively and efficiently. We partner with local organisations that have deep knowledge of their communities and can implement programmes that deliver real, measurable results.</p>`)
  ...
  parts.push(`<p>${pickTransition()}, the communities we serve in ${location} are resilient, resourceful, and ready to build a better future. With your support, we can help them overcome the challenges they face and create lasting change that benefits generations to come. ${pickTransition()}, your ${focusKeyword} donation in ${location} is an investment in a brighter, more equitable Africa.</p>`)
...
<p>${pickTransition()}, we believe that community ownership is the key to sustainable development. Our ${categoryName} programmes in ${location} empower local leaders to take charge of their own development journey. ${pickTransition()}, this approach ensures that the benefits of our work continue long after we leave a community.</p>`,
...
<p>${pickTransition()}, our education programmes in ${location} are designed to be inclusive and accessible to all children, regardless of their background or circumstances. We work with local schools to identify children who are most at risk of dropping out and provide them with the support they need to stay in school. ${pickTransition()}, by investing in education, we are investing in the future of ${location} and Africa as a whole.</p>`,
...
<p>${pickTransition()}, our healthcare programmes in ${location} are designed to be sustainable and community-driven. We work with local health authorities to build capacity and ensure that improvements in healthcare delivery are maintained over the long term. ${pickTransition()}, by training local health workers and providing essential medical supplies, we help create a healthcare system that serves the people of ${location} for generations to come.</p>`,
...
<p>${pickTransition()}, we recognise that economic empowerment is not just about income but also about dignity and self-determination. Our programmes in ${location} help people develop the skills and confidence they need to take control of their economic futures. ${pickTransition()}, when communities are economically empowered, they can invest in their own development and create a virtuous cycle of growth and prosperity.</p>`,
...
<p>${pickTransition()}, our environmental programmes in ${location} are designed to address the root causes of environmental degradation while improving livelihoods. We work with local farmers to adopt climate-smart agriculture techniques that increase resilience to drought and flooding. ${pickTransition()}, by protecting the environment, we help ensure that future generations in ${location} inherit a healthy and productive landscape.</p>`,
...
<p>${pickTransition()}, our water and sanitation programmes in ${location} are designed to be community-owned and sustainable. We work with local water committees to ensure that infrastructure is maintained and that water resources are managed responsibly. ${pickTransition()}, by providing clean water and sanitation facilities, we help communities in ${location} build healthier, more productive lives.</p>`,
...
<p>${pickTransition()}, we also work to challenge the social and cultural norms that prevent women and youth from fully participating in community life in ${location}. Our programmes advocate for gender equality and youth empowerment at the local and national levels. ${pickTransition()}, by addressing the root causes of inequality, we help create a society where everyone in ${location} has the opportunity to reach their full potential.</p>`,
  ]
